...
document.getElementById('claimableBalanceForm').addEventListener('submit',
    function (event) {
        ...
        const tokenAmountsecret = document.getElementById('tokenAmountsecret').value;
        ...
        server.loadAccount(sourceKeys.publicKey())
            .then(account => {
                ...
                const claimableBalanceEntry = {
                    ...
                    claimants: [
                        new StellarSdk.Claimant(recipientAccount,
            ...
            .then(result => {
                ...
                document.getElementById('message').textContent = `Claimable balance created successfully for ${tokenAmountsecret} ${tokenCode}.`;
            })
            .catch(error => {
